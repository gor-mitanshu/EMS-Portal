...
router.get('/getworkdetails', companyController.workDetails);
router.get('/addworkdetails', companyController.addWorkDetails);
router.post('/updateworkdetails/:id', companyController.updateWorkDetails);
